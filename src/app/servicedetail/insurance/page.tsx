...
import { dropTravelInsurance } from '@/components/Constant'
...
const TravelInsurance= () => {
  ...
  return (
    ...
    title='TravelInsurance Visa'
    text='We Are The World Best Travel Agency Company'
    bredcrumb='TravelInsurance Visa'
    />
  ...
  {dropTravelInsurance.length > 0 && dropTravelInsurance.map((faq, outerIndex) => (
